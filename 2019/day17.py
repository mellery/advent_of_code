...
def solve_part1(program: str) -> int:
    ...
    bot = ScaffoldBot(program)
    bot.scan_scaffolds()
    return bot.calculate_alignment_sum()

def solve_part2(program: str) -> int:
    """Legacy function for direct solving."""
    solution = Day17Solution()
    return solution.part2(program)
...
def solve_day17(filename: str = "day17_input.txt") -> Tuple[int, int]:
    ...
    solution = Day17Solution()
    part1_result = solution.part1(program)
    part2_result = solution.part2(program)
