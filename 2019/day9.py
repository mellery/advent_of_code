...
class Day9Solution(AdventSolution):
    ...
    def validate(self, expected_part1=None, expected_part2=None) -> bool:
        ...
        outputs2 = machine2.run()
        
        if len(str(outputs2[0])) != 16:
            print(f"Test 2 failed: should output 16-digit number, got {outputs2[0]}")
            return False
        
        # Test case 3: Program that outputs the large number in the middle
        test3 = "104,1125899906842624,99"
        machine3 = Intcode(test3)
        outputs3 = machine3.run()
        
        if outputs3[0] != 1125899906842624:
            print(f"Test 3 failed: expected 1125899906842624, got {outputs3[0]}")
            return False
